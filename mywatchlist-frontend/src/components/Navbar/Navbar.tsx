                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-wrap justify-between">
                        ...
                        <div className="flex items-center space-x-1">
                            <div className="pt-2 relative mx-auto text-black dark:text-white">
                                <input className="border-2 border-black dark:border-white bg-white dark:bg-dark_bg h-10 px-10 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search"/>
